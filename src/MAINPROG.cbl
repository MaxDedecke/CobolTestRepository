      ...
      * Including copybooks from copy/ directory
           ...
           COPY "SYS-CONFIG.cpy".
           COPY "TRANS-REC.cpy" REPLACING TRANS-REC BY WS-TRANS-REC.
       ...
       000-START.
           ...
           MOVE "STARTING " TO WS-LOG-MSG.
           STRING WS-LOG-MSG SYS-NAME INTO WS-LOG-MSG.
           CALL "LOGGER" USING WS-LOG-DATA.

           DISPLAY "SYSTEM: " SYS-NAME " VERSION: " SYS-VERSION.
           ...
           DISPLAY "--- STAGE 3: TRANSACTION PROCESSING ---".
           PERFORM 400-TRANS-TEST.

           DISPLAY "--- STAGE 4: FILE PROCESSING ---".
       ...
       400-TRANS-TEST.
           MOVE "TR-1001" TO TRANS-ID OF WS-TRANS-REC.
           MOVE 20260615 TO TRANS-DATE OF WS-TRANS-REC.
           MOVE 500.00 TO TRANS-AMOUNT OF WS-TRANS-REC.
           MOVE USER-ID TO TRANS-USER-ID OF WS-TRANS-REC.
           MOVE "TEST TRANSACTION" TO TRANS-DESC OF WS-TRANS-REC.
           SET TRANS-DEBIT OF WS-TRANS-REC TO TRUE.
           SET TRANS-PENDING OF WS-TRANS-REC TO TRUE.

           CALL "TRANSPROG" USING WS-TRANS-REC.
           
           DISPLAY "TRANS STATUS AFTER CALL: " TRANS-STATUS OF WS-TRANS-REC.

       FINALIZATION-SECTION SECTION.
       300-FINALIZE.
           DISPLAY "SHUTTING DOWN " SYS-NAME.
