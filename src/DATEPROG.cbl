      *****************************************************************
      * PROGRAM: DATEPROG
      * PURPOSE: UTILITY FOR DATE HANDLING AND FORMATTING
      * AUTHOR:  GEMINI-CLI
      *****************************************************************
       ...
       DATA DIVISION.
      *****************************************************************
      * LINKAGE SECTION: RECEIVES REQUEST ACTION AND DATE DATA
      *****************************************************************
       LINKAGE SECTION.
       01  LK-DATE-REQUEST.
      ...
      *****************************************************************
      * MAIN-LOGIC: EVALUATES THE REQUESTED ACTION
      *****************************************************************
       MAIN-LOGIC SECTION.
       000-START.
           EVALUATE TRUE
      *        GET CURRENT SYSTEM DATE AND FORMAT AS ISO (YYYY-MM-DD)
               WHEN ACT-GET-DATE
      ...
      *        FORMAT PROVIDED NUMERIC DATE AS ISO (YYYY-MM-DD)
