...
then
    ...
    echo "Compiling src/DATEPROG.cbl..."
    echo "Compiling src/REPORTPROG.cbl..."
...
mkdir -p bin
cobc -x -o bin/VERFAHREN src/VERFAHREN.cbl src/MAINPROG.cbl src/UTILPROG.cbl src/FILEPROG.cbl src/LOGGER.cbl src/VALIDATOR.cbl src/DATEPROG.cbl src/REPORTPROG.cbl -I copy/
